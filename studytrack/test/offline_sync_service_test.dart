...
void main() {
  ...
  group('OfflineDataStore queue semantics', () {
    ...
    test('queues and reads pending CRUD changes in insertion order', () async {
      ...
      expect(pending[0].entity, 'topics');
      expect(pending[1].recordId, 'topic-1');
      expect(pending[2].payload['id'], 'topic-1');
    });
