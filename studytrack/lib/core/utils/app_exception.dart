...
class OfflineException extends AppException {
  OfflineException({required super.message, String? code, super.stackTrace})
    : super(code: code ?? 'OFFLINE_ERROR');
}

/// Validation exceptions
class ValidationException extends AppException {
  ValidationException({required super.message, String? code, super.stackTrace})
    : super(code: code ?? 'VALIDATION_ERROR');
}

/// Generic app exceptions
class AppGenericException extends AppException {
  AppGenericException({required super.message, String? code, super.stackTrace})
